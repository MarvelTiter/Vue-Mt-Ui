<template>
  <div
    class="mt-image-preview-wrapper"
    @click="close"
    v-if="show"
    ref="ImgBoardContainer"
  >
    ...
    <div class="mt-image-preview-message" @click.stop>
      <p><slot :item="currentItem"></slot></p>
...
export default {
  ...
  computed: {
    ShowImage: function () {
      var img = this.list[this.index][this.src] || this.list[this.index];
      return img;
    },
